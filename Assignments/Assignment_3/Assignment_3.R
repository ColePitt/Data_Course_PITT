...
new_edit = as.numeric(as.character(dat$Headwidth))

dat$Headwidth <- new_edit
...
?jpeg()
jpeg("../Data_Course_PITT/Assignments/R Assingments/testimage.jpg")
plot(nums, main = "My Title", xlab= "My axis label", ylab = "My other axis label")
